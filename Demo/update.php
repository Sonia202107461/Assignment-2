...
$id = $first_name = $last_name = $email = $DOB = $gender = $contact = $departure_city = $destination_city = $flight_number = "";
$id_err = $first_name_err = $last_name_err = $email_err = $DOB_err = $gender_err = $contact_err = $departure_city_err = $destination_city_err = $flight_number_err = "";
...
if (isset($_POST["id"]) && !empty($_POST["id"])) {
    ...
    $input_departure_city = trim($_POST["departure city"]);
    ...
    //} elseif (!ctype_digit($input_departure_city)) {
     ...
     $input_destination_city = trim($_POST["destination city"]);
     ...
     $input_flight_number = trim($_POST["flight number"]);
    ...
    if (empty($first_name_err) && empty($last_name_err) && empty($email_err) && empty($DOB_err) && empty($gender_err) && empty($contact_err) && empty($departure_city_err) && empty($destination_city_err) && empty($flight_number_err)) {
        ...
        $sql = "UPDATE cutomer SET first_name=?, last_name=?, email=?, DOB=?, gender=?, contact=?, departure_city=?, destination_city=?, flight_number=? WHERE id=?";

        if ($stmt = mysqli_prepare($link, $sql)) {
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sssssssssi", $param_first_name, $param_last_name, $param_email, $param_DOB, $param_gender, $param_contact, $param_departure_city, $param_destination_city, $param_flight_number, $param_id);
